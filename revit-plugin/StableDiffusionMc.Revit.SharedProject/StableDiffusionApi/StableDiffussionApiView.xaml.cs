            ...
            if (sender is TextBox textBox)
            {
                switch (textBox.Name)
                {
                    ...
                    case nameof(StrengthTextBox):
                        ...
                        break;
                    case nameof(InferenceStepsTextBox):
                        if (int.TryParse(textBox.Text, out var inferenceSteps))
                            viewModel.NumInferenceSteps = inferenceSteps;
                        break;
                    case nameof(ControlNetTextBox):
                        if (double.TryParse(textBox.Text, out var controlNet))
                            viewModel.ConronetConditioningScale = controlNet;
                        break;
                }
            }
        }
